...
#dhgfasjhfkj,dfhskjdfhwekfdsjd    
logger = logging.getLogger()
logger.setLevel(logging.DEBUG)

headers = { "Content-Type": "application/json" }
host = "https://search-photos-tyy2xhbikqwrquuxoaok26pyym.us-east-1.es.amazonaws.com/photo-album/_doc"
region = 'us-east-1'
...
def get_photo_path(labels):
    ...
    for i in labels:
        ...
        print(path)
        response = requests.get(path, headers=headers, auth=('prateek', 'Prateek@1709'))
