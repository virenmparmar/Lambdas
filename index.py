...
def lambda_handler(event, context):
    ...
    print('I am here')
    url = "https://search-photos-tyy2xhbikqwrquuxoaok26pyym.us-east-1.es.amazonaws.com/photo-album/_doc"
    headers = {"Content-Type": "application/json"}
    
    r = requests.post(url, data=json.dumps(format).encode("utf-8"), headers=headers, auth=('prateek', 'Prateek@1709'))
